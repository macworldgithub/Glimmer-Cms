...
const UpdateStoreModal: React.FC<PropsUpdateStoreModal> = ({
  ...
  const handleUpdate = async () => {
    try {
      ...
      // Assuming updateStoreApi expects token in headers
      const res = await axios.put(
        `/api/store/update`, // Adjust endpoint as per your API
        data,
        {
          headers: {
      ...
      if (res.data) {
        dispatch(updateStore({ type: "updateStore", payload: res.data }));
      }
