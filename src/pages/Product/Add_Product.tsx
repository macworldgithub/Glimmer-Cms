        ...
        <div className=" mx-auto overflow-hidden">
            <div className="p-6 flex flex-col md:flex-row md:items-center md:justify-between ">
                ...
                <div className="flex gap-2 mt-4 md:mt-0 max-sm:gap-1 max-sm:flex-col">
                    <div className="flex flex-row">
                        <button className=" text-gray-700 px-4 py-2 rounded-md">Discard</button>
                        <button className=" text-gray-700 px-4 py-2 rounded-md">Save Draft</button>
                    </div>
                    <div>
                        <button className="bg-[#5f61e6] text-white px-4 py-2 rounded-md ">Publish Product</button>
                    </div>
                </div>
            </div>
            {/* Main Content */}
            <div className="flex gap-x-4 flex-col lg:flex-row ">
                <div className="w-2/3 max-lg:w-full">
                    <div className="border-gray-200  rounded-md  bg-gray-100 p-6 my-2">
                        <h2 className="text-lg  mb-4 text-gray-700 ">Product information</h2>
                        <div className="mb-4">
                        ...
                        <div>
                            ...
                            <textarea
                                placeholder=""
                                className="w-full rounded-md shadow-sm p-3 border-solid border   border-gray-400">  </textarea>
                        </div>
                    </div>

                    <div className="border-gray-200  rounded-md max-md:w-full bg-gray-100 px-4 py-2 my-4">
                        <div className="mt-4 flex flex-row justify-between max-sm:flex-col max-sm:mt-1">
                            ...
                            <div>
                                <button className="text-sm text-[#5F61E6] hover:underline">Add media from URL</button>
                            </div>
                        </div>
                        <div className="mb-6 border-gray-300 rounded-md">
                            <p className="text-gray-800 font-medium text-xl max-sm:text-md">Drag and drop your image here</p>
                            <p className="text-gray-500 mt-2 text-xsm">or</p>
                            <p className="text-gray-500 text-xsm">Browse image</p>

                            <div className="mt-4">
                                <input type="file" className="max-sm:text-[10px] text-sm text-gray-700" />
                            </div>
                        </div>
                    </div>

                    <div className="border-gray-200  rounded-md max-md:w-full bg-gray-100 p-4  my-4">


                        <h2 className="text-lg  mb-4 text-gray-700">Variants</h2>
                        <label className="block text-xsm font-medium text-gray-600 mb-1">Options</label>
                        ...
                        <button className="bg-[#5F61E6] text-white px-4 py-2 rounded-md">+ Add another option</button>
                    </div>
                    ...
                    <div className="border-gray-200  rounded-md max-md:w-full bg-gray-100 px-4 py-2 my-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <div className="block text-md font-medium text-gray-700 mb-2">Options</div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Add to Stock</label>
                                <input
                                    type="number"
                ...
                <div className="w-1/3 max-lg:w-full">
                    <div className="p-6 bg-gray-100 rounded-md my-4">
                        ...
                        <div className="mb-4 flex items-center">
                            <input
                                ...
                                defaultChecked
                            />
                            <label htmlFor="charge-tax" className="ml-2 text-sm text-gray-700">
                    ...
                    <div className="shadow-md  p-6 bg-gray-100 rounded-md max-md:w-full">
