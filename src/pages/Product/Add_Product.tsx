...
const ProductPage = () => {
    ...
    //@ts-ignore
    const sub_category_options = categoryData?.filter(cat => cat?._id === category)[0]?.sub_categories
    const item_options = sub_category_options?.filter((sub: any) => sub?._id === subcategory)[0]?.items
                            ...
                            >
                                <option value="">Select Category</option>
                                {
                                    categoryData.map((cat: any) => {
                                        return <option value={cat?.product_category?._id}>{cat?.product_category?.name}</option>
                                    })
                                }
                            </select>
